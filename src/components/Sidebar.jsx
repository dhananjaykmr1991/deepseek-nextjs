    ...
    max-md:h-screen ${expand ? 'p-4 w-64':'md:w-20 w-0 max-md:overflow-hidden'}`}>
        <div onClick={()=>setExpand(!expand) }>
            <div className={`flex ${expand ? 'flex-row gap-10':'flex-col items-center gap-8'}`}>
                ...
                <div className='group relative flex items-center justify-center hover:bg-gray-500/20 transition-all 
                duration-300 h-9 w-9 aspect-square rounded-lg cursor-pointer'>
                    ...
                    group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none`}>
                      ...
                      <div className={`w-3 h-3 absolute bg-black rotate-45 ${expand ? 'left-1/2 -top-1.5 -translate-x-1/2' 
      ...
      <div>
        ...
        <div className={`flex items-center ${expand ? 'hover:bg-white/10 rounded-lg' : 'justify-center w-full'} gap-3 text-white/60 text-sm p-2 mt-2 
        cursor-pointer`}>
